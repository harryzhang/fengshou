...
<script type="text/javascript" src="<c:url value='/js/policytype/policytype.js?v='/>${jsversion}"></script>
<style type="text/css">
.tdfont{
	font-size: 12px;
}
...
<div id="body" region="center" > 
  <!-- 查询条件区域 -->
	<div id="search_areaPolicyType"  class="easyui-panel" >
		<div id="conditon" >
			<form id="searchpolicyTypeForm" style="margin-top:7px;margin-left:5px;" >
			      <table border="0">
			        <tr>
  	...
  	<!-- 数据表格区域 -->
  <div id="tt_PolicyType"></div>
  
</div>

  <div id="editPolicyTypeDiv"></div>  
</body>
