...
<script type="text/javascript" src="<c:url value='/js/user/index.js?v=${jsversion}'/>"></script>
			...
			<form id="searchForm" style="margin-top:7px;margin-left:5px;" >
			      <table border="0">
			        <tr>
						...
						<td class="tdfont">手机号:<input type="text" size="14" id="userMobile" name="userMobile" placeholder="手机号" ></td>
					   	<td class="tdfont" colspan="2">注册时间:
