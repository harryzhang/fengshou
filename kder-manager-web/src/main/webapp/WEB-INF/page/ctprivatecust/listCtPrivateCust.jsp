...
<script type="text/javascript" src="<c:url value='/js/ctPrivateCust/ctprivatecust.js?v=${jsversion}'/>"></script>
<style type="text/css">
.tdfont{
	font-size: 12px;
}
...
<div id="body" region="center" > 
  <!-- 查询条件区域 -->
	<div id="search_areaCtPrivateCust"  class="easyui-panel" >
		<div id="conditon" >
			<form id="searchctPrivateCustForm" style="margin-top:7px;margin-left:5px;" >
			      <table border="0">
			        <tr>
			          <td class="tdfont">查询条件:
			          	<input type="text" size="14" id="searchUserName" name="searchUserName" placeholder="用户名称 " >
			          	<input type="text" size="14" id="searchPhone" name="searchPhone" placeholder="手机号" >
			          </td>
			          <td >
