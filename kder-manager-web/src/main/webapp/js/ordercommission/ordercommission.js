...
/*#############################################search form begin#################################*/	
	...
	$("#searchorderCommissionForm #searchButton").on("click",function(){
		$("#tt_OrderCommission").datagrid('load',{
			'searchStr': $("#searchorderCommissionForm #searchStr").val(),
			'searchCodeStr':$("#searchorderCommissionForm #searchCodeStr").val()		
		});
	});
	...
	var columns_tt = [
      			[	 				
							{field:'id',title:'id',width:100,hidden:true},						
								...
								{field:"orderId",title:"编码",width:180,align:"center"},
								{field:"userName",title:"编码",width:180,align:"center"},
								{field:"commissionAmt",title:"编码",width:180,align:"center"},
								{field:"orderNo",title:"编码",width:180,align:"center"},
								{field:"status",title:"编码",width:180,align:"center"},
								{field:"auditStatus",title:"编码",width:180,align:"center"},
								{field:"auditTime",title:"编码",width:180,align:"center",formatter:dateTimeFormatter},
								{field:"auditId",title:"编码",width:180,align:"center"},
