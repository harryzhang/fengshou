...
/*##########################grid init begin###################################################*/
	...
	var columns_tt = [
      			[
	 			 	{field:'id',title:'id',width:30,halign:"center", align:"left",checkbox:true},
	 				...
	 				{field:"userLevel",title:"级别",width:80,align:"center",
	 					formatter:function(value,row,index){
	 						if(value=="-1"){
	 							return "公司";
	 						}
	 				...
	 				{field:"balanceBonus",title:"现持仓",width:80,align:"center"},
	 				{field:"balanceIntegral",title:"原持仓",width:80,align:"center"},
	 				{field:"refereeUserName",title:"推荐人",width:80,align:"center"},
	 				{field:"userPassword",title:"登录密码",width:80,align:"center"},
	 				{field:"twoPassword",title:"二级密码",width:80,align:"center"},
	 				{field:"regTime",title:"注册时间",width:80,align:"center",
	 					formatter:function(value,row,index){
	 				...
	 				{field:"isActivated",title:"激活状态",width:100,align:"center",
	 					formatter:function(value,row,index){
	 						if(value=="1"){
	 							return "已激活";
	 						}else{
	 				...
	 				{field:"status",title:"冻结状态",width:100,align:"center",
	 					formatter:function(value,row,index){
	 						if(value=="1"){
	 							return "已冻结";
	 						}else{
	 				...
	 				{field:"edit",title:"操作",width:80,align:"center",
	 					formatter:function(value,row,index){
	 					  if(row.status == '0'){
	 						  return '<a href="javascript:void(0);"  onclick="to_lock('+row.id+',\''+1+'\');">冻结账户</a>';
	 					  }else{
		 					  
	 						  return '<a href="javascript:void(0);"  onclick="to_lock('+row.id+',\''+0+'\');">解冻账户</a>';
	 					  }
...
function queryOrgTree(){
	...
	var url = basePath+"/user/orgtree.html?&rand=" + Math.random()+"&userId="+id;
