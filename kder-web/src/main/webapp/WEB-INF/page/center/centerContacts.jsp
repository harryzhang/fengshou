...
<div class="container mt20 clearfix">
    <div class="side-nav">
        ...
        <dl>
            ...
            <dd class="on"><a href="center_contacts.html">常用联系人</a></dd>
        </dl>
        <dl>
            <dt>
                <i class="i2"></i>
    ...
    <div class="center-content">
        <div class="inner-content">
            <div class="center-title clearfix">
                <span>常用联系人</span>
                <p class="right-btn"><a href="center_add_contacts.html">添加联系人</a></p>
            </div>
            <div class="contact-content" id="appCtrl" v-loack style="min-height:500px">
                <table>
                    <tr>
                        <th>姓名</th>
                        <th>证件号</th>
                    ...
                    <tr>
                        <td>张三</td>
                        <td>125232259525235256</td>
                        <td>1980-09-09</td>
                        <td>男</td>
                        <td>
                            <el-button-group>
                              <el-button size="mini" plain icon="el-icon-edit" @click="edit('fdsafsadf')">修改</el-button>
                              <el-button size="mini" plain icon="el-icon-delete" @click="delete('fasdfsf')">删除</el-button>
                            </el-button-group>
                        </td>
                    </tr>
                </table>
    ...
    <script>
        var vm = new Vue({
            ...
            methods:{
                ...
                edit: function(id){
                    location.href = 'center_add_contacts.html'
                }
            }
        })
    </script>
