...
<body>
    ...
    <div class="top-header">
        <div class="container clearfix">
            ...
            <ul class="header-nav">
                <li><a target="_self" href="http://www.fengshou-ins.com/index.html">首 页</a></li>
                <li><a target="_self" href="http://www.fengshou-ins.com/products_list.html">全部保险产品</a></li>
                ...
                onSubmit: function(){
                    ...
                    this.$refs.form.validate(function(valid){
                        if(valid){
                            $.ajax({
            						type: 'POST',
            						url:'http://www.fengshou-ins.com/kder-api/user/changePwd.do',
